...
(function(w,d){
	...
	var no_of_img = 5,
		...
		css = '#debra{margin:auto;width:600px;}.ip{margin:auto;padding:0 50px;}input{font-size: 1.2em; height:50px; margin-top:10px; padding:10px; border-radius:5px;aline:cete} .thumb{height:100px;width:100px;border-radius:5px;margin:0 5px;}.v{visibility: visible;opacity: 1;transition: opacity 2s linear;}.h{visibility: hidden;opacity: 0;transition: visibility 0s 1s, opacity 1s linear;display:none;}',
